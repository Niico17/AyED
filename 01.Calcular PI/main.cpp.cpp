...
{
 float Pi = 0.0;
 float precision = 0.00000000001;  // Precisión de ejemplo aproximada
 float PD = 3.141592000000; //Prec Deseada, los digitos necesarios, y de ultima, relleno con varios 0
 int denom = 1.0;
